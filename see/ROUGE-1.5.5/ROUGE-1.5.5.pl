...
sub printResults {
  ...
  if(!defined($opt_t)||$opt_t==1) {
    print STDERR "$peerID $methodTag Average_R: $ROUGEAverages->{'AvgR'} ";
    print STDERR "($opt_c\%-conf.int. $ROUGEAverages->{'CIAvgL_R'} - $ROUGEAverages->{'CIAvgU_R'})\n";
    print STDERR "$peerID $methodTag Average_P: $ROUGEAverages->{'AvgP'} ";
    print STDERR "($opt_c\%-conf.int. $ROUGEAverages->{'CIAvgL_P'} - $ROUGEAverages->{'CIAvgU_P'})\n";
    print STDERR "$peerID $methodTag Average_F: $ROUGEAverages->{'AvgF'} ";
    print STDERR "($opt_c\%-conf.int. $ROUGEAverages->{'CIAvgL_F'} - $ROUGEAverages->{'CIAvgU_F'})\n";
  }
  else {
    print STDERR "$peerID $methodTag M_count: ";
    print STDERR int($ROUGEAverages->{'M_cnt'});
    print STDERR " P_count: ";
    print STDERR int($ROUGEAverages->{'P_cnt'});
    print STDERR " H_count: ";
    print STDERR int($ROUGEAverages->{'H_cnt'});
    print STDERR "\n";
  }
  if(defined($opt_d)) {
    print ".............................................\n";
